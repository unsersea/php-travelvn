...
foreach ($result as $row) {
    ...
    $sub_array[] =
        '
        <a class="btn btn-info text-white" data-id="' . $row["id"] . '" id="btn-update-event">
            <i class="bx bx-edit-alt"></i>
        </a>
        <a class="btn btn-danger text-white" data-id="' . $row["id"] . '" id="btn-delete-event"> 
            <i class="bx bx-trash"></i>
        </a>
        <a class="btn btn-warning text-white" data-id="' . $row["id"] . '" id="btn-detail-event">
...
$output = array(
    ...
    "recordsFiltered" => EventClass::ListByPDO(),
    "data" => $data
);
