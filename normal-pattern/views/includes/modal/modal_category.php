...
<div class="modal fade" id="modal-create-category" tabindex="-1" aria-labelledby="ex-modal-label" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="../../views/includes/modal/modal_category.php" id="form-create-category" class="form form-modal" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="field-modal textarea">
                        ...
                        <!-- Setup Textarea -->
                        <textarea name="dis-tmce-content-category" id="dis-tmce-content-category" rows="4" class="form-control tinymce"></textarea>
                        <textarea name="get-tmce-content-category" id="get-tmce-content-category" rows="" class="" hidden="true"></textarea>
                    </div>
                </div>
            ...
            <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="field-modal textarea">
                        ...
                        <!-- Setup Textarea -->
                        <textarea name="dis-tmce-content-category-update" id="dis-tmce-content-category-update" rows="4" class="form-control tinymce"></textarea>
                        <textarea name="get-tmce-content-category-update" id="get-tmce-content-category-update" rows="" class="" hidden="true"></textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Đóng</button>
