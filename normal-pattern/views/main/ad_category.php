                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="btn-link-create-category">
                                        <a href="#" data-id="" data-toggle="modal" data-target="#modal-create-category" class="btn btn-success text-white">
                                ...
                                <div class="card-body">
                                    <table id="datatables-category-list" class="table table-bordered table-hover nowrap datatables">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Thể Loại</th>
